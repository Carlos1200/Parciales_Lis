...
<form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">   
        ...
        <div class="item">
          <label class="form-label" for="seleccion_periodo">Seleccionar periodo de pago: <span>*</span></label>
          <select name="seleccion_periodo" class="form-select">           
        ...
        <div class="item">
          <label class="form-label" for="date">Fecha del préstamo: <span>*</span></label>
          <input id="fecha_des" type="date" name="fecha_des" class="form-control" required/>
        </div>
        <div class="item">
          <label class="form-label" for="interes">Interes del préstamo (%): <span>*</span></label>
          <input type="number" name="interes" class="form-control"  required />
    
        </div>
        <div class="item">
          <label class="form-label" for="plazo">Plazo del préstamo: <span>*</span></label>
          <input type="number" name="plazo" class="form-control" required/>
        </div>
        <div class="item">
          <label class="form-label" for="importe">Importe del préstamo: <span>*</span></label>
          <input type="number" name="importe" class="form-control" required/>
        </div>
       
        <div class="btn-block">
        <input class="btn btn-success my-3" type="submit" name="enviar" value="Ver resultados"> 
        </div>
      </form>
    </div>
